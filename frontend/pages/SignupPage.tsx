            ...
            <div className="relative mx-auto w-full max-w-md">
                <div className="text-center">
                    ...
                    <p className="mt-2 text-sm text-slate-600 dark:text-slate-400">
                        Join SyncHub and start organizing your teams and projects.
                    </p>
                </div>
                ...
                <div className="mt-8 rounded-card border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-700 dark:bg-slate-900 sm:p-8">
                    ...
                    <p className="mt-6 text-center text-sm text-slate-600 dark:text-slate-400">
                        ...
                        <Link to="/login" className="cursor-pointer font-semibold text-primary transition hover:text-primary/80">
                            Log in
                        </Link>
                    </p>
                </div>
